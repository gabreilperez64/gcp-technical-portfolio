...
**Core Projects:** KemnayUSA, Otavalo
* [cite_start]**Resource Hierarchy:** Architected GCP organization structures using Folders and Projects to ensure strict billing and resource isolation[cite: 7].
...
**Core Projects:** New Carrollton, Frontarange, ISTA
* [cite_start]**Dynamic Routing:** Deployed **HA VPN with Cloud Router** using **BGP** for resilient, dynamic route advertisement between on-prem and GCP VPCs[cite: 56, 57].
...
* [cite_start]**Load Balancing:** Engineered External HTTP(S) Load Balancers with custom Health Check strategies (TCP vs. HTTPS) to handle SSL termination issues[cite: 318, 326, 333].

## ☸️ 3. Modernization & GKE Operations
**Core Projects:** Hillspire, MIVI
...
* [cite_start]**Cert-Manager Recovery:** Diagnosed and repaired broken **cert-manager** installations by regenerating expired internal CAs and fixing webhook readiness probes[cite: 97, 102, 103].
...
**Core Projects:** ISTA, Backup & DR Sessions
* [cite_start]**Critical Incident Response:** Resolved a 2-week migration blocker by identifying a stopped **Netlogon service** on a Cloud Domain Controller[cite: 156, 157].
* [cite_start]**Database PITR:** Performed **Point-in-Time Recovery (PITR)** and file-level restores using **Google Cloud Backup and DR** for MariaDB/MySQL environments[cite: 212, 214].
...
> [cite_start]**Methodology:** My approach consistently prioritizes the **Principle of Least Privilege** [cite: 33][cite_start], **Root Cause Analysis (RCA)** [cite: 66, 151][cite_start], and translating technical evidence into strategic business plans[cite: 64, 87].
